package com.mitsuki.armory.base.view.widget
...
class RatingView @JvmOverloads constructor(
    ...
    var borderDrawable = obtainDrawable(R.drawable.m_armory_base_ic_baseline_star_border_16)
    var halfDrawable = obtainDrawable(R.drawable.m_armory_base_ic_baseline_star_half_16)
    var solidDrawable = obtainDrawable(R.drawable.m_armory_base_ic_baseline_star_16)
    ...
    fun setDrawable(
        @DrawableRes solid: Int = R.drawable.m_armory_base_ic_baseline_star_16,
        @DrawableRes half: Int = R.drawable.m_armory_base_ic_baseline_star_half_16,
        @DrawableRes border: Int = R.drawable.m_armory_base_ic_baseline_star_border_16
    ) {
